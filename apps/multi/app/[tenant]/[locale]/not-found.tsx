...
/**
 * Rendered without params, so it cannot know the tenant's locale. It uses the default
 * dictionary and links to the site root, which the proxy resolves back to the right language.
 */
